    ...
    <div class="container">
        <div class="hero-content">
            <div class="hero-left">
                ...
                <p class="hero-desc">Nepal Ride Hub provides reliable vehicle rental services across Nepal. Whether you need a bike for adventure, a car for comfort, or a bus for group travel, we have everything for your journey.</p>
                ...
                <a href="vehicles.php" class="btn-blue-solid" style="padding: 1.2rem 2.8rem; border-radius: 12px; font-size: 1.1rem; box-shadow: 0 10px 25px rgba(53,97,255,0.3);">Explore Vehicles</a>
            </div>
            <div class="hero-right">
                <div class="hero-carousel">
                    <button class="carousel-btn carousel-prev"><i class="fa-solid fa-chevron-left"></i></button>
                    <img src="https://images.unsplash.com/photo-1555215695-3004980ad54e?auto=format&fit=crop&w=800&q=80" alt="Featured Car">
    ...
    <div class="container">
        <div class="booking-steps-container">
            <div class="step-item">
                ...
                <p class="step-desc">Select your preferred vehicle, tailored to your journey as per your requirement.</p>
            </div>
            <div class="step-item">
                <div class="step-number">2</div>
                <h3 class="step-title">Make a Booking</h3>
                <p class="step-desc">You can make easy bookings through our user-friendly app or a simple phone call.</p>
            </div>
            <div class="step-item">
...
<section style="padding: 4rem 0;">
    <div class="container">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem; text-align: center;">
            ...
            <div>
                <i class="fas fa-calendar-check" style="font-size: 3rem; color: var(--primary-blue); margin-bottom: 1rem;"></i>
                <h3>3. Book & Ride</h3>
