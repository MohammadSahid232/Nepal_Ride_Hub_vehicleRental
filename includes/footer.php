    ...
    <footer class="footer">
        <div class="container footer-content">
            ...
            <div class="footer-contact">
                ...
                <p><i class="fas fa-phone"></i> <a href="tel:+97714000000" style="color: inherit; text-decoration: none;">+977 1-4000000</a></p>
                <p><i class="fas fa-envelope"></i> <a href="mailto:support@nepalridehub.com" style="color: inherit; text-decoration: none;">support@nepalridehub.com</a></p>
                <p><i class="fas fa-location-dot"></i> <a href="https://www.google.com/maps/search/?api=1&query=Kathmandu,Nepal" target="_blank" style="color: inherit; text-decoration: none;">Kathmandu, Nepal</a></p>
            </div>
        </div>
